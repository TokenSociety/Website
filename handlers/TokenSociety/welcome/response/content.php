...
function TokenSociety_welcome_response_content($params)
{
	// Do controller stuff here. Prepare variables
	$tabs = array("foo" => "bar");
	$description = "this is a description";
    Q_Response::addStylesheet('css/pages/welcome.css');
	...
	$comingsoon = array(
		'Kolodny.jpg' => 'Kolodny',
		'Bogart.gif' => 'Eddie Bogart',
		'Malik.jpg' => 'Asante Malik',
		'Marso.gif' => 'Marso',
		'RonKing.jpg' => 'Ron King'
	);
	
	$socials = array(
		'telegram' => 'https://t.me/tokensociety',
		'twitter' => 'https://twitter.com/thetokensociety',
		'instagram' => 'https://instagram.com/tokensociety.io',
		'github' => 'https://github.com/TokenSociety'
	);

	$isMobile = Q_Request::isMobile();

	return Q::view('TokenSociety/content/welcome.php', compact(
		'tabs', 'description', 'comingsoon', 'socials', 'isMobile'
	));
}
